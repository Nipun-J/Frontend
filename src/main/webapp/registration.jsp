...
<%--            <form class="form" >--%>
        <form class="form" onsubmit="event.preventDefault(); ApiCallForUserSave();">
...
<%--            <button class="animation a6" id="submitBtn" onclick="ApiCallForUserSave()">Submit</button>--%>
...
// ajax
    ...
    let address = document.getElementById("addressI");
    let phoneNumber = document.getElementById("phoneI");
    let nic = document.getElementById("nicI");
    let birthday = document.getElementById("birthdayI");
    let age = document.getElementById("ageI");
    let gender = document.getElementById("genderI");
